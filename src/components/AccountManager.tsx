...
const AccountManager: React.FC<AccountManagerProps> = ({
  ...
  const handleAddAccount = () => {
    ...
    // Show QR modal instead of directly adding to database
  ...
  const handleQRSuccess = (accountData: { name: string; phoneNumber: string }) => {
    // Now add to database with the scanned phone number
    onAddAccount(accountData.name);
    setShowQRModal(false);
    setPendingAccountName('');
    
    toast({
      title: "Account Connected",
      description: `${accountData.name} has been connected successfully!`
    });
  };
